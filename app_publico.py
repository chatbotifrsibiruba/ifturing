...
/* Esconde apenas os itens indesejados da toolbar, sem sumir com ela toda.
   O botão de expandir a sidebar (stExpandSidebarButton) fica dentro de
   stToolbar no Streamlit ≥ 1.60 — esconder a toolbar inteira o apagaria. */
...
/* NÃO esconder o header — o botão de expandir a sidebar vive nele.
   Usamos position:relative + height:auto e fixamos o botão de toggle
   com position:fixed para que fique sempre visível e clicável. */
...
/* Botão de expandir sidebar (Streamlit ≥ 1.60): fixado no canto superior
   esquerdo, acima de qualquer outro elemento, inclusive o card branco. */
...
<a href="https://ifrs.edu.br/ibiruba/" target="_blank" rel="noopener noreferrer" style="color:#FFF;text-decoration:none;font-size:14px;">Site IFRS Ibirubá</a>
<a href="https://vemproif.ibiruba.ifrs.edu.br/" target="_blank" rel="noopener noreferrer" style="color:#FFF;text-decoration:none;font-size:14px;">Vem pro IF Ibirubá</a>
...
def salvar_log(pergunta: str, m: dict) -> int | None:
    ...
    return salvar_consulta_no_banco(st.session_state.db_sessao_id, cfg, pergunta, m)
